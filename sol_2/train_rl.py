...
Cấp độ:
  Level 1 – REINFORCE + EMA Baseline  (từ sol_1, cải tiến)
...
#    Nguồn: sol_1/train_rl.py (cải tiến: cùng interface với Level 2/3)
# =============================================================================
...
def run_rl(model_name: str, checkpoint: str, cfg: dict, args):
    ...
    # ── DataLoaders ──────────────────────────────────────────────────────
    data_root = cfg.get('data_root', '../data/V2')
