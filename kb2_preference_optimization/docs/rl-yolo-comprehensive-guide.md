...
>
> **Nguồn:** DPO/GRPO/DAPO guide (kb2_preference_optimization/docs) + REINFORCE pipeline (kb1_reward_guided_training) +
...
*Tài liệu tổng hợp từ: DPO/GRPO/DAPO guide (kb2_preference_optimization/docs), DeepSeek-R1/Math papers,
DAPO paper, yanivnik/Google DeepMind 2023, cv-rl (bwconrad), kb1_reward_guided_training REINFORCE pipeline.*
