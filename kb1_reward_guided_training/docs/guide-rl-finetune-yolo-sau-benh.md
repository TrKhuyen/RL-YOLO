# LEGACY GUIDE: REINFORCE PROTOTYPE

> Tài liệu này mô tả prototype cũ và không còn là đặc tả triển khai chuẩn.
> Guide chính thức cho KB1-B là
> [KB1B_REWARD_GUIDED_WEIGHT_TUNING.md](KB1B_REWARD_GUIDED_WEIGHT_TUNING.md).
> Không dùng các khuyến nghị small-object reward, ImageNet normalization hoặc
> 20k-100k steps trong tài liệu legacy này cho thí nghiệm mới.
